...
void MainWindow::addMenusToMenuBar()
{
    ...
    ui->menuBar->addMenu(m_pViewMenu);
    ui->menuBar->addMenu(m_pProcessMenu);
    ui->menuBar->addMenu(m_pProgramSetMenu);
    ui->menuBar->addMenu(m_pToolMenu);
    ui->menuBar->addMenu(m_pWindMenu);
    ui->menuBar->addMenu(m_pSetUpMenu);
    ui->menuBar->addMenu(m_pAboutMenu);
    ui->menuBar->addMenu(m_pHelpManualMenu);
}

void MainWindow::addActiontosToToolBar()
{
    ui->mainToolBar->setMovable(false);
    ui->mainToolBar->addAction(m_pOpenFileAction);
    ui->mainToolBar->addAction(m_pSaveFileAction);
    ui->mainToolBar->addAction(m_pSAveAsFileAction);
    ui->mainToolBar->addAction(m_pImputApdlModelFileAction);
    ui->mainToolBar->addAction(m_pImputFeamModelFileAction);
    ui->mainToolBar->addAction(m_pImputTestModelFileAction);
    ui->mainToolBar->addSeparator();
    ui->mainToolBar->addAction(m_pSelectFromAction);
    ui->mainToolBar->addAction(m_pSetToSelfAction);
    ui->mainToolBar->addSeparator();
    ui->mainToolBar->addAction(m_pShowDataTreeAction);
    ui->mainToolBar->addAction(m_pShowCommonAction);
    ui->mainToolBar->addSeparator();
    ui->mainToolBar->addAction(m_pShowWindowsAsTabsAction);
    ui->mainToolBar->addAction(m_pShowWindowsAsVerticalAction);
    ui->mainToolBar->addAction(m_pShowWindowsAsHorizontalAction);
    ui->mainToolBar->addAction(m_pShowWindowsAsStackAcion);
    ui->mainToolBar->addSeparator();
    ui->mainToolBar->addAction(m_pAboutAction);
    ui->mainToolBar->addAction(m_pExitAction);
